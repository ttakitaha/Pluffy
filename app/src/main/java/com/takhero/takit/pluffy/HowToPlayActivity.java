...
// Check if the app is launched first time before setting layout
            ...
            prefManager.setIsFirstLaunch(true);
        ...
        public void onBackPressed(){
            super.onBackPressed();
            startActivity(new Intent(HowToPlayActivity.this, OptionsActivity.class));
            finish();
        }

        private void launchMainScreen() {
            prefManager.setIsFirstLaunch(false);
            startActivity(new Intent(com.takhero.takit.pluffy.HowToPlayActivity.this,MainActivity.class));
            finish();
        }
